...
const DATA = [
  ...
  GAP('Desire Blue', 'Borderline-keep row (discontinued, deep discounter stock). Needs a source lookup for the pyramid.'),
  ...
  GAP('Signorina Uomo', 'SUSPECT NAME: Signorina is a Ferragamo women’s line; no "Signorina Uomo" is known. Likely a corruption of Uomo Salvatore Ferragamo (2016). Needs verification before any pyramid.'),
  ...
  GAP('Portrait of a Lady Intense', 'SUSPECT NAME: no Intense version of Portrait of a Lady is known in the Frederic Malle line. Needs verification before any pyramid.'),
